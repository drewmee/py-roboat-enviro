...
class BaseAPI(object):
    ...
    def __init__(self, token=None, *args, **kwargs):
        if token:
            ...
            self.token = os.environ.get("ROBOAT-ENVIRO_APIKEY", None)
        
        self.endpoint = kwargs.pop("endpoint", "https://api.roboat-enviro.com/device-api/")
